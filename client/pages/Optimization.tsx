            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Kelola dan optimasi konflik jadwal
                </p>
              </div>
            </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {optimizationStatus === "running" &&
                          "Sedang mengoptimasi jadwal..."}
                        {optimizationStatus === "completed" &&
                          "Optimasi selesai"}
                        {optimizationStatus === "idle" && "Siap untuk optimasi"}
                        {optimizationStatus === "error" &&
                          "Terjadi error dalam optimasi"}
                      </p>
                    </div>
                    <div className="flex items-center space-x-2">
                      {optimizationStatus === "running" && (
                ...
                <div className="space-y-4">
                  ...
                  {conflicts.length === 0 && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600">
                        Semua jadwal telah dioptimasi dengan baik
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  {optimizationHistory.map((history, index) => (
                    <div key={index} className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-xs text-gray-600">
                        ...
                        <div>
                          Konflik: {history.conflicts_before} →{" "}
                          {history.conflicts_after}
                        </div>
                      </div>
                    </div>
                  ))}
